function [allClusters, cut,cheeger,cutPart1,cutPart2,threshold] =  createClusters(vmin,W,normalized,threshold_type,criterion,deg,notinsideregion)
% Transforms eigenvector into cluster indicator function by thresholding.
% 
...
%  notinsideregion  - don't consider cheeger cuts where you threshold 
